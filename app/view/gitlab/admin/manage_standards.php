...
<head  >
    ...
    <script src="<?=ROOT_URL?>dev/js/admin/manage_standard.js?v=<?=$_version?>" type="text/javascript" charset="utf-8"></script>
...
<script type="text/html"  id="list_tpl">
    {{#available_standards}}
        ...
        <tr class="commit">
            <td>
                <strong class="prepend-left-5">{{standard_name}}</strong>
            </td>
            <td>
                {{description}}
            </td>
...
<script type="text/javascript">
    ...
    $(function() {
        ...
        var options = {
            ...
            filter_url:"<?=ROOT_URL?>admin/standard/fetchStandards",
