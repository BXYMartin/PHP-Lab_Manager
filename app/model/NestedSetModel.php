...
class NestedSetModel {
  ...
  public function __construct($pdo, $persistent = false) {
    $this->pdo = $pdo;
    $this->table = 'standard_main';
    $this->keyColumn = 'sid';
    $this->treeColumn = 'tree_id';
  ...
  public function treeze(&$branch, $parentId = 0, $childrenKey = 'section') {
    foreach ($this->getTree($parentId) as $element) {
