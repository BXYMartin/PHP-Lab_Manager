...
(3, '会议接机', '--教授预计将于--月--日--点到达--机场--航站楼，航班号为--。请--同学前往接机。\r\n注意保存登机牌作为报销单据。\r\n--教授预定的酒店时--酒店，在接到教授后送到酒店即可。\r\n注意保存出租车发票或电子发票作为报销单据。', 1572177896, 0), 
(4, '会议送机', '--教授预计将于--月--日--点从--机场--航站楼出发，航班号为--。教授所在的酒店是--酒店，请--同学适当提前一段时间前往送机。\r\n注意保存登机牌照片作为报销单据。\r\n注意保存出租车发票或电子发票作为报销单据。', 1572177997, 0), 
(5, '会议邀请函', '主要研究--的--教授预计将于--月--日来我校访问，请准备一份会议邀请函，并找学院签字盖章。', 1572178085, 0), 
(6, '会议海报', '--教授预计将于--月--日--点为师生在--教室做一场报告，主要关于--课题。详细内容见附件，请--同学制作一份报告海报用作宣传。', 1572178166, 0);
...
(1, 1, '测试实例', 'bug', 'Standard', '测试过程、维护过程发现影响系统运行的缺陷', 'fa-bug', NULL, 1, 1), 
(2, 2, '新功能', 'new_feature', 'Standard', '对系统提出的新功能', 'fa-plus', NULL, 1, 2), 
(3, 3, '任务', 'task', 'Standard', '需要完成的任务', 'fa-tasks', NULL, 1, 0), 
(4, 4, '优化改进', 'improve', 'Standard', '对现有系统功能的改进', 'fa-arrow-circle-o-up', NULL, 1, 1), 
...
(1390, 9, 'edit', 11, 1, 0, 1), 
(1391, 9, 'edit', 24, 0, 0, 1), 
(1415, 12, 'edit', 25, 0, 0, 1), 
(1431, 14, 'edit', 28, 0, 0, 1), 
(1432, 13, 'edit', 27, 0, 0, 1), 
(1433, 11, 'edit', 24, 0, 0, 1), 
(1434, 11, 'create', 1, 6, 0, 1), 
(1435, 11, 'create', 2, 5, 0, 1), 
(1436, 11, 'create', 12, 4, 0, 1), 
(1437, 11, 'create', 4, 3, 0, 1), 
(1438, 11, 'create', 20, 2, 0, 0), 
(1439, 11, 'create', 6, 1, 0, 1), 
(1440, 11, 'create', 24, 0, 0, 0), 
(1441, 12, 'create', 1, 6, 0, 1), 
(1442, 12, 'create', 2, 5, 0, 1), 
(1443, 12, 'create', 12, 4, 0, 1), 
(1444, 12, 'create', 4, 3, 0, 1), 
(1445, 12, 'create', 20, 2, 0, 0), 
(1446, 12, 'create', 6, 1, 0, 1), 
(1447, 12, 'create', 25, 0, 0, 0), 
(1448, 13, 'create', 1, 6, 0, 1), 
(1449, 13, 'create', 4, 5, 0, 1), 
(1450, 13, 'create', 20, 4, 0, 0), 
(1451, 13, 'create', 6, 3, 0, 1), 
(1452, 13, 'create', 26, 2, 0, 1), 
(1453, 13, 'create', 12, 1, 0, 1), 
(1454, 13, 'create', 13, 0, 0, 1), 
(1455, 14, 'create', 1, 6, 0, 1), 
(1456, 14, 'create', 4, 5, 0, 1), 
(1457, 14, 'create', 20, 4, 0, 0), 
(1458, 14, 'create', 6, 3, 0, 1), 
(1459, 14, 'create', 2, 2, 0, 1), 
(1460, 14, 'create', 12, 1, 0, 1), 
(1461, 14, 'create', 13, 0, 0, 1),
(1462, 8, 'create', 24, 12, 0, 0),
(1463, 8, 'edit', 24, 12, 0, 0);
...
(10000, 'Users', '普通用户', 0),
(10001, 'Developers', '开发者', 0),
(10002, 'Administrators', '项目管理员', 0),
(10003, 'Researchers', '研究人员', 0),
(10006, 'Professors', '教职人员', 0);
